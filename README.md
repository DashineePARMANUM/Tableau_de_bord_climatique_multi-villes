...
- **`data`** = datasets
  ...
  - `ville_4.csv` = files from which data relating to snow (Ottawa/Vancouver) and pressure (other) have been removed in order to contain only the columns present in the 6 datasets
